...
-	You can specify the list of adapter sequences with –adapters (-a) specifier. 
	-	Each fastq.gz file contains 855,983 reads. 
-	Other software options: FastQC is for illumina read, NGSQC is for basically every platform 
...
-	FastX-toolkit (instruction: http://hannonlab.cshl.edu/fastx_toolkit/commandline.html)
...
-	HISAT2 (v 2.1.0) maps the reads for each sample to the ref genome:
-	Help page: hisat2 –h 
...
-	Other software options: Picard, STAR, PSeQC, Qualimap 
...
-	Other software available: HTSeq-count, featureCounts 
